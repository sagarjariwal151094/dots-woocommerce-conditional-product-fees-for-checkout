module.exports = function(grunt){
    ...
    var SOURCE_DIR = './', //root path of plugin folder
        ...
        TEXT_DOMAIN = ['woocommerce-conditional-product-fees-for-checkout', 'woocommerce'], //list out textdomain for check in whole plguin files
    ...
    grunt.initConfig({
        ...
        jsvalidate: {
            ...
            src: [ '**/*.js', '!**/freemius/**', '!**/node_modules/**', '!**/vendor/**', '!**/*.min.js', '!**/Gruntfile.js', '!**/jquery.*.js', '!**/chart.js'],
        },
